...
//           alert("Your Payment information is saved successfully, start your journey by selecting your photos");
//           navigate('/');
//         } else {
...
//           <input type="text" name="expirationDate" value={formData.expirationDate} onChange={handleInputChange} required />
...
//           <p>Selected Credit Coin: €{price}</p>
//         </div>
//       </div>
//     </div>
